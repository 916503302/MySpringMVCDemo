...
public class Config {
    ...
    public static final String TEST_FIXTURES_PATH = "/D:/springtest/src/test/fixture";
...
//                    DEFAULT_CONFIG));
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (runningFabricCATLS) {
                    String cert = "/D:/springtest/src/test/fixture/sdkintegration/e2e-2Orgs/channel/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
    ...
    public String getTestChannelPath() {
        ...
        return "/D:/springtest/src/test/fixture/sdkintegration/e2e-2Orgs/channel";
